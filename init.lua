  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sl', function()
        vim.ui.input({ prompt = 'file type filter (*.*) > ' }, function(input)
          if input then require('telescope.builtin').live_grep { glob_pattern = input } end
        end)
